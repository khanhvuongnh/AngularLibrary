...
export class AppComponent implements OnInit {
  ...
  constructor(private functionUtlity: FunctionUtility, private notiflixService: NgxNotiflixService, private service: MediaUploaderService) {}
  ngOnInit(): void {
  ...
  handleResult(event: OperationResult): void {
    ...
    console.log(URL.createObjectURL(this.modelB.file));
  }
